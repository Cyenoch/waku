...
mod tests {
    ...
    fn attachment_messages_keep_transport_and_visible_content_separate() {
        ...
        let attachment = MessageAttachment {
            ...
            is_dir: false,
            is_image: true,
            blob_reference: Some("wakuwaku-blob:ab/reference.png".to_owned()),
        };
    ...
    fn activity_targets_are_normalized_when_events_arrive() {
        let cases = [
            (
                ActivityKind::FileRead,
                serde_json::json!({"input": {"file_path": "/tmp/wakuwaku/src/app.rs"}}),
                "/tmp/wakuwaku/src/app.rs",
            ),
            (
                ActivityKind::FileSearch,
            ...
            (
                ActivityKind::FileList,
                serde_json::json!({"arguments": {"directory": "/tmp/wakuwaku/src"}}),
                "/tmp/wakuwaku/src",
            ),
            (
