...
use ts_rs::{Config, TS};
use wakuwaku_protocol::composer::ReportedCommand;
...
fn generated_output() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("../../packages/wakuwaku-client/src/generated")
}
...
fn export_to(output: &Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    fs::write(
        ...
        format!(
            "// Generated from wakuwaku-protocol. Do not edit.\n\
