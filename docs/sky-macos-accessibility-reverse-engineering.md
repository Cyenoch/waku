...
This is the critical path for WakuWaku parity.
...
## Why WakuWaku's previous approximation failed
...
## Compatibility requirements for WakuWaku
...
1. Codex/WakuWaku remains the actual frontmost application throughout.
